  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
    ...
    <div className="space-y-5">
      ...
      <p className="text-gray-600 text-lg leading-relaxed">
        Traveling opens your mind, challenges your comfort zone, and connects
        you with cultures, people, and experiences that last a lifetime.
        It’s not just about where you go — it’s about who you become along the way.
      </p>

      <p className="text-gray-600">
        From peaceful beaches to vibrant cities, every journey teaches
        you something new. Travel slowly, travel intentionally, and let
        the world shape your story.
      </p>
    </div>
